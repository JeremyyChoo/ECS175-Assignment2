...
class AmbientLight extends Light {
    ...
    update( ) {
        ...
        this.target_shader.setUniform3f('u_lights_ambient[' + this.id + '].color', new Float32Array([this.color[0], this.color[1], this.color[2]]))
...
class DirectionalLight extends Light {
    ...
    update( ) {
        ...
        // TODO: Pass the light properties to the shader
        this.target_shader.use()
        let direction = vec3.normalize(vec3.create(), [this.model_matrix[12], this.model_matrix[13], this.model_matrix[14]])
        this.target_shader.setUniform3f('u_lights_directional[' + this.id + '].direction', new Float32Array([direction[0], direction[1], direction[2]]))
        this.target_shader.setUniform3f('u_lights_directional[' + this.id + '].color', new Float32Array([this.color[0], this.color[1], this.color[2]]))
...
class PointLight extends Light {
    ...
    update( ) {
        ...
        // TODO: Pass the light properties to the shader
        this.target_shader.use()
        let position = [this.model_matrix[12], this.model_matrix[13], this.model_matrix[14]]
        this.target_shader.setUniform3f('u_lights_point[' + this.id + '].position', new Float32Array([position[0], position[1], position[2]]))
        this.target_shader.setUniform3f('u_lights_point[' + this.id + '].color', new Float32Array([this.color[0], this.color[1], this.color[2]]))
