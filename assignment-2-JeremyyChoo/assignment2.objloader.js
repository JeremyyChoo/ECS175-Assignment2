...
class OBJLoader {
    ...
    parseVec3(vec_string) {
        ...
        let arr = vec_string.split(' ').slice(1).map(Number);
        return arr
    }
    ...
    {
        // NOTE: You can re-use A4's code here
        let arr = face_string.split(' ').slice(1).map(item => {
        ...
        switch(entry_index) {
            case 0:
                result = [arr[0][0] - 1, arr[1][0] - 1, arr[2][0] - 1]
                break;
            case 1:
                result = [arr[0][1] - 1, arr[1][1] - 1, arr[2][1] - 1]
                break;
            case 2:
                result = [arr[0][2] - 1, arr[1][2] - 1, arr[2][2] - 1]
                break
        }

        // console.log(arr); // [[2, 1, 1], [3, 2, 1], [1, 3, 1]]
        return result
    }
