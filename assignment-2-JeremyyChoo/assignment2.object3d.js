...
class Object3D
{
     ...
     */
    constructor( gl, shader, vertices, indices, draw_mode, hasNormal )
    {
    ...
    createVBO( gl )
    {
        ...
        const positionAttributeLocation = gl.getAttribLocation(this.shader.program, 'a_position');
        ...
        const normalAttributeLocation = gl.getAttribLocation(this.shader.program, 'a_normal');
...
class ShadedObject3D extends Object3D { 
     ...
     * @param {WebGL2RenderingContext.GL_TRIANGLES | WebGL2RenderingContext.GL_POINTS} draw_mode The draw mode to use. In this assignment we use GL_TRIANGLES and GL_POINTS
     */
     constructor( material, gl, shader, vertices, indices, draw_mode, hasNormal ) {
        super(gl, shader, vertices, indices, draw_mode, hasNormal)
